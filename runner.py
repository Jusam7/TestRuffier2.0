...
class Runner(BoxLayout):
    ...
    def __init__(self,
        ...
        self.animation = (Animation(pos_hint = {'top': 0.1}, duritation = steptime/2)
                        + Animation(pos_hint = {'top': 1.0}))
        self.animation_on_progress = self.next
    ...
    def start(self):
        self.value = 0
        self.finished = False
        self.btn.next = self.btext_inprogress
        if self.autorepeat:
